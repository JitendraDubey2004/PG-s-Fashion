...
import Payment from "./components/Bag/Payment";
import OrderSuccess from "./components/Bag/OrderSuccess";
import Chatbot from "./components/Chatbot/Chatbot";
import MyOrders from "./components/Orders/MyOrders";
import Account from "./components/Login/Account";
import VisualSearchPage from "./components/VisualSearch/VisualSearchPage";
 ...
 const [state, setstate] = useState(false)
  ...
  return (
    <Router>
      ...
      <Route path='/payment/bag' element={<Payment />}/>
