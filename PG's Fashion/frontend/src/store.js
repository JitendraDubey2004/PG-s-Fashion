...
import {Allproducts, singleProduct, newReviewReducer} from './Reducer/productreducer'
import { create_bag_reducer, create_wishlist_reducer, delete_bag_reducer, delete_wish_reducer, get_bag_reducer, get_wishlist_reducer, update_qty_bag_reducer, create_order_reducer, my_orders_reducer } from './Reducer/orderreducer';
...
const reducer = combineReducers({
      ...
      newOrder: create_order_reducer,
      myOrders: my_orders_reducer,
