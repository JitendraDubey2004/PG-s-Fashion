                ...
                <div>
                  ...
                  <div className="col-span-5 text-[14px] ">
                    <div className='mt-2 '>
                      ...
                      {couponInfo && (
                        <div className='text-[#0db7af] relative mt-2'>Coupon Discount <span className='text-xs'>({couponInfo.coupon})</span><span className='absolute right-0'>-&#8377;&nbsp;{couponInfo.discountAmount}</span></div>
                      )}
                      ...
                      <div className='py-2 border-t-[1px] border-slate-200 bg-white 2xl:relative xl:relative lg:relative'>
                        <div className='relative font1 text-base'>Total Amount<span className='absolute right-0'>&#8377;&nbsp;{Math.round(sp - (couponInfo?.discountAmount || 0))}</span></div>

                        <button className='mt-2 bg-[#ff3f6c] text-center w-full py-3 font1 text-bold text-white' onClick={() => redirect('/payment/bag')}> CONTINUE </button>
                      </div>
                    </div>
