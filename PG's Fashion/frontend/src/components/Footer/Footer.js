  ...
  return (
    <Fragment>
    {
      ...
      <div className='w-10/12 mx-auto grid grid-cols-12 mt-12 font1'>
       ...
       <h1 className='text-sm font-semibold col-span-2'>EXPERIENCE PG'S FASHION APP ON MOBILE</h1>
       ...
       <div className="col-span-4">
            <div className='grid grid-cols-6 '>
                  ...
                  for all products at pgsfashion.com
                    </div>
            </div>
            <br />
            <div className='grid grid-cols-6 '>
      ...
      <div className='w-10/12 mx-auto font1 text-base text-slate-600'>
        ...
        <h1>
        Makeup | Dresses For Girls | T-Shirts | Sandals | Headphones | Babydolls | Blazers For Men | Handbags | Ladies Watches | Bags | Sport Shoes | Reebok Shoes | Puma Shoes | Boxers | Wallets | Tops | Earrings | Fastrack Watches | Kurtis | Nike | Smart Watches | Titan Watches | Designer Blouse | Gowns | Rings | Cricket Shoes | Forever 21 | Eye Makeup | Photo Frames | Punjabi Suits | Bikini | PG's Fashion Fashion Show | Lipstick | Saree | Watches | Dresses | Lehenga | Nike Shoes | Goggles | Bras | Suit | Chinos | Shoes | Adidas Shoes | Woodland Shoes | Jewellery | Designers Sarees
        </h1>
      </div>
      <div className='relative w-10/12 mx-auto text-slate-600'>
        <span className='absolute right-0'> © 2022 www.pgsfashion.com. All rights reserved.</span> 
      </div>
    </Fragment>
    ...
    <Fragment>
       ...
       <div className="mt-4">
       <h1 className='text-base font-semibold '>EXPERIENCE PG'S FASHION APP ON MOBILE</h1>
       ...
       <div className='flex mx-auto text-slate-400 mt-4 mb-20'>
        <div className=' text-xs float-left'> © 2022 www.pgsfashion.com All rights reserved</div>
      </div>
      </div>
