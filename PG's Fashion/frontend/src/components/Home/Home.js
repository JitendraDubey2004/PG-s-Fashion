        ...
        window.screen.width > 1024 ?
          ...
          <Fragment>
            ...
            {recommendations.length > 0 && (
              <div className='my-8 bg-gradient-to-r from-purple-50 to-pink-50 py-8'>
                <h1 className='text-3xl px-8 font-bold font1 tracking-widest text-slate-800 mb-8'>RECOMMENDED FOR YOU</h1>
                <div className='flex overflow-x-auto gap-4 px-8 pb-4 hide-scroll-bar'>
                  {recommendations.map((item) => (
                    <Link to={`/products/${item._id}`} key={item._id} className='min-w-[200px] max-w-[200px] bg-white p-2 rounded shadow-sm hover:shadow-md transition-shadow'>
                      <img src={item.images && item.images[0] ? item.images[0].url : ''} alt={item.title} className='w-full h-[250px] object-cover mb-2 rounded' />
                      <h3 className='font1 font-bold text-sm truncate'>{item.brand}</h3>
                      <p className='font1 text-xs text-gray-500 truncate'>{item.title}</p>
                      <p className='font1 text-sm font-semibold mt-1'>Rs. {item.sellingPrice}</p>
                    </Link>
                  ))}
                </div>
              </div>
            ...
            <div>
              <h1 className='text-3xl px-8 font-bold font1 tracking-widest text-slate-800 mb-8 mt-8'>BEST OF PG'S FASHION EXCLUSIVE BRANDS</h1>
            ...
            <div>
              <h1 className='text-3xl px-8 font-bold font1 tracking-widest text-slate-800 mb-8 mt-8'>PG'S FASHION LUXE</h1>
              <div className='grid grid-cols-8 gap-1'>
            ...
            <div>
              <h1 className='text-3xl px-8 font-bold font1 tracking-widest text-slate-800 mb-8 mt-8'>SPRING SUMMER 2022- FIRST ON PG'S FASHION</h1>
              <div className='grid grid-cols-8 '>
          ...
          <Fragment>
            ...
            <div>
              <h1 className='text-xl px-8 font-bold font1 text-center text-slate-800 mb-6 mt-6'>BEST OF PG'S FASHION EXCLUSIVE BRANDS</h1>
              <ul className='flex overflow-x-scroll '>
