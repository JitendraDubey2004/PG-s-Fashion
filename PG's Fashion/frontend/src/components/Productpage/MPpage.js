                            ...
                            <div className='bg-[#e9e9e9] '>
                                ...
                                <div className='mt-2 pb-6 pt-4 relative bg-white px-4 grid grid-cols-12'>
                                    ...
                                    <div className='col-span-9'>
                                        ...
                                        <h1 className='text-sm font1 text-slate-500 mt-2'>Applicable on your first order. <br />  Use code: PG300</h1>
                                    </div>
                                ...
                                <div className='mt-2 pb-6 pt-4 relative bg-white px-4'>
                                    ...
                                    <li className='list-none text-slate-500 text-sm'>Coupon code: <span className='font-semibold'>PG250</span></li>
