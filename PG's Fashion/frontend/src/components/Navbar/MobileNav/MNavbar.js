                ...
                <div className=' border-b-2 h-14 px-3 py-3 '>
                    <div className='my-auto grid grid-flow-col auto-cols-max'>
                        <div className='flex '>
                           ...
                           <Link to='/'> <h1 className='text-[#282c3f] text-xl py-1 ml-2'>PG's Fashion</h1></Link>
                        </div>
                        ...
                        >
                            ...
                            <Offcanvas.Body className='border-none'>
                                ...
                                <div className='px-5 text-[#282c3fd2] text-sm'>
                                    <h1 className='my-5'>PG's Fashion&nbsp;Studio&nbsp;<span className=' py-[2px] px-2 text-[8px] font-bold border-2 text-[#ee5f73] border-[#ee5f73] rounded-lg' >NEW</span></h1>
                                    <h1 className='my-5'>PG's Fashion&nbsp;Mall&nbsp;<span className=' py-[2px] px-2 text-[8px] font-bold border-2 text-[#ee5f73] border-[#ee5f73] rounded-lg' >NEW</span></h1>
                                    <h1 className='my-5'>PG's Fashion&nbsp;Insider</h1>
