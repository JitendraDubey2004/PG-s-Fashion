            ...
            <div className=' w-full'>
               ...
               {user ? "" : <h1 className='font1 font-extralight text-sm '>To access account and manage orders  <br /></h1>}
                ...
                {user && user.role === 'admin' && (
                  <Link to="/admin/dashboard"><h1 className='litext list-none py-0.5  hover:font-semibold text-[#ff3f6c]'>Admin Dashboard</h1></Link>
                )}
                <Link to="/my_orders"><h1 className='litext list-none py-0.5  hover:font-semibold text-black'>Orders</h1></Link>
                <Link to="/my_wishlist"><h1 className='litext list-none py-0.5  hover:font-semibold text-black'>Wishlist</h1></Link>
                ...
                <div className='flex'>
                <h1 className='litext list-none py-0.5  hover:font-semibold'>PG's Fashion Insider </h1><div className='bg-[#ff3f6c] flex w-max h-max ml-2 mt-2 float-left px-1 text-xs skewnew text-white'>New</div>
                </div>
               

                <hr className='my-4' />

                <h1 className='litext list-none py-0.5  hover:font-semibold'>PG's Fashion Credit</h1>
