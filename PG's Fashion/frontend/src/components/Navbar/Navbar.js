...
import './Navbar.css'
import pgsfashion from '../images/myntra.svg'
import { FaRegUser, FaMoon, FaSun } from 'react-icons/fa'
import { BsHeart, BsHandbag, BsCamera } from 'react-icons/bs'
        ...
        <div className='2xl:grid xl:grid grid-cols-2 lg:flex h-full mx-6  '>
          ...
          <ul className=' h-full flex font1 font-semibold text-base md:text-[14px] text-[#282c3f] tracking-[.3px] uppercase'>
            ...
            <li className='w-max flex items-stretch'  >
              <img src={pgsfashion} alt="PG's Fashion Logo" className='w-14' />
            </li>
            </Link>
            <Link className='w-max px-3 flex items-stretch' to="/">
          ...
          <div className=' h-full justify-center items-center '>
            <ul className='flex float-right  h-full  text-[#282c3f] tracking-[.3px] sent'>
              ...
              <li className='w-max flex justify-center items-center font1 font-semibold capitalize no-underline text-sm border-4 border-transparent mr-4'>
                <button onClick={toggleDarkMode} title="Toggle Dark Mode" className='text-gray-500 hover:text-[#ff3f6c] transition-colors'>
                  {isDarkMode ? <FaSun className='text-xl' /> : <FaMoon className='text-xl' />}
                </button>
              </li>
              <li className='w-max flex justify-center items-center font1 font-semibold capitalize no-underline text-sm border-4 border-transparent mr-4'>
                <Link to='/visual-search' title="Visual Search" className='text-gray-500 hover:text-[#ff3f6c] transition-colors'>
